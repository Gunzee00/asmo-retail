              ...
              <div className='about-two-content'>
                <div className='mb-40'>
                  <div className='flex-align d-inline-flex gap-8 mb-16 wow bounceInDown'>
                    ...
                    <h5 className='text-main-600 mb-0'>Kenapa Harus Memilih Kami</h5>
                  </div>
                  <h2 className='mb-24 wow bounceIn'>
                    Dirancang dengan Standar Psikometri
                  </h2>
                  <p className='text-neutral-500 text-line-2 wow bounceInUp'>
                    Seluruh instrumen assessment dikembangkan berdasarkan prinsip validitas dan reliabilitas sehingga hasil dapat dipercaya untuk pengambilan keputusan.
                  </p>
                </div>
                <div className='grid-cols-2'>
                  ...
                  >
                    ...
                    <div className='flex-grow-1'>
                      <h6 className='text-neutral-800 text-xl fw-medium mb-8'>
                        Mendukung Berbagai Kebutuhan Bisnis & Pendidikan
                      </h6>
                  ...
                  >
                    ...
                    <div className='flex-grow-1'>
                      <h6 className='text-neutral-800 text-xl fw-medium mb-8'>
                        Laporan Hasil yang Jelas & Actionable
                  ...
                  >
                    ...
                    <div className='flex-grow-1'>
                      <h6 className='text-neutral-800 text-xl fw-medium mb-8'>
                        Fleksibel, Aman, & Berbasis Teknologi
