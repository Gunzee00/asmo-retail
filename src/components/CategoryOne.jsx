      ...
      <div className="container">
        <div className="section-heading text-center">
          ...
          <h2 className="mb-24 wow bounceIn">
            Pilih Kategori Assassment Sesuai Kebutuhan Kamu
          </h2>
          <p className=" wow bounceInUp">
            Temukan jenis tes yang paling relevan untuk seleksi, evaluasi
            kinerja, atau pengembangan individu.
          </p>
        </div>
