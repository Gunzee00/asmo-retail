            ...
            <div className='row gy-4 align-items-center'>
                ...
                <div className='join-community__content'>
                  <div className='mb-40'>
                    <h2 className='mb-24 wow bounceIn'>
                      Mulai Gunakan Assessment Online Sekarang
                    </h2>
                    <p className='text-neutral-500 text-line-2 wow bounceInUp'>
                      Siap melihat bagaimana assessment digital bekerja? Daftar dan coba versi demo untuk merasakan alur pengerjaan serta melihat contoh hasil laporan.
                    </p>
                  </div>
                  <form action='#'>
                    <div
              ...
              <div className='col-lg-6'>
                <div className='join-community__thumb text-end position-relative'>
                  <img
                    src= 'assets/images/thumbs/about-image3.png'
                    alt=''
